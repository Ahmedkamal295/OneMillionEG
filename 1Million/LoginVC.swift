...
class LoginVC: UIViewController {
    ...
    @IBAction func btnLogin(_ sender: UIButton) {
        ...
        if ((txtIdNumber.text?.isEmpty)! || (txtPassword.text?.isEmpty)!) {
            ...
            btnLoginOutlet.backgroundColor = UIColor.gray
            ...
            Alamofire.request(loginurl, method: .post, parameters: parameters)
                .responseJSON { response in
                    ...
                    if ("\(result)" != "SUCCESS") {
                        ...
                        self.btnLoginOutlet.backgroundColor = #colorLiteral(red: 0.8928823471, green: 0.2479706109, blue: 0.1964860559, alpha: 1)
                    ...
                    if let arrayOfDic = result.value as? Dictionary<String, AnyObject> {
                        ...
                        self.btnLoginOutlet.isEnabled = false
                        self.activtyInd.stopAnimating()
                        print(token)
