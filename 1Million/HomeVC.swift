                     ...
                     Alamofire.request(url, method: .get, parameters: nil)
                         .responseJSON { response in
                          ...
                          var data = Response?["data"] as? NSDictionary
                            ...
                            self.lblmutual.text = data?["members"] as? String ?? "0"
                             
                            self.lblMony.text = data?["prize"] as? String ?? "0"
                         
                            
                            var starttime = data?["start_time"] as? NSDictionary
                            
                            self.lblDay.text = "\(starttime?["day"] as? Int ?? 0)"
                            self.lblhour.text = "\(starttime?["hour"] as? Int ?? 0)"
                            self.lblminute.text = "\(starttime?["minute"] as? Int ?? 0)"
